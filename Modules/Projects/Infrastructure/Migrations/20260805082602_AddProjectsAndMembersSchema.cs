...
{
    /// <inheritdoc />
    public partial class AddProjectsAndMembersSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProjectScopedRole = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectFavorites_ProjectId_UserId",
                table: "ProjectFavorites",
                columns: new[] { "ProjectId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProjectJoinRequests_ProjectId_RequestingUserId",
                table: "ProjectJoinRequests",
                columns: new[] { "ProjectId", "RequestingUserId" });
